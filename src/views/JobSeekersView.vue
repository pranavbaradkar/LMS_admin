  ...
  <v-container fluid class="pa-8">
    <v-row justify="space-between">
      <v-col cols="4" md="4" sm="4">
        <div class="text-h5">Job Seekers</div></v-col
      >
    </v-row>
    <v-row style="align-items: center">
      <v-col class="mb-1">
        <v-menu offset-y>
          ...
          <v-list>
            ...
            >
              <v-list-item-title>
                <v-icon>mdi-email-plus-outline</v-icon> CREATE NEW JOBSEEKER
              </v-list-item-title>
            </v-list-item>
            <v-list-item>
              <v-list-item-title>
            ...
            <v-list-item>
              <v-list-item-title>
                <v-icon>mdi-account-multiple-plus </v-icon> CREATE JOB SEEKERS
                IN BULK
              </v-list-item-title>
            </v-list-item>
          </v-list>
      ...
      >
      <v-col sm="8" md="8" cols="8" class="d-flex" style="align-items: center">
        <v-text-field
          label="Search"
      ...
      <template v-slot:[`item.actions`]="{ item }">
        ...
        >
          <img
            ...
            height="36px"
            src="../assets/edit.svg"
          /><img width="36px" height="36px" src="../assets/userdelete.svg" />
        </div>
      </template>
                            ...
                            <v-expansion-panel-content>
                              ...
                              <v-row>
                                ...
                                >
                                  ...
                                  <v-btn
                                    v-if="professionalInfos.length != 1"
                                    @click="openDeleteDiolog(index)"
                                    text
                                    class="d-flex justify-end red--text"
                                    >Remove</v-btn
