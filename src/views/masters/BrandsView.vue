        ...
        <v-btn
          v-if="
            (user_permission.master &&
              ...
              user_permission.master.child.brands.create) ||
            user.role_type == 'SUPER_ADMIN'
          "
          @click="(dialog = true), newCreateBrands()"
          class="background_btn white--text"
          large
          rounded-lg
          ><v-icon>mdi-plus</v-icon>Create Brand</v-btn
        >
      ...
      <v-col class="d-flex" style="align-items: center">
        ...
        <v-btn
          v-if="
            (user_permission.master &&
              user_permission.master.child.brands &&
              user_permission.master.child.brands.delete) ||
            user.role_type == 'SUPER_ADMIN'
          "
      ...
      <template v-slot:[`item.actions`]="{ item }">
        <v-btn
          v-if="
            (user_permission.master &&
              user_permission.master.child.brands &&
              user_permission.master.child.brands.update) ||
            user.role_type == 'SUPER_ADMIN'
          "
          icon
          class="mr-2 pa-4"
