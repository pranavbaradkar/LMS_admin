    ...
    <div id="myScroll" class="navCard">
      <v-list>
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title class="white--text">Interview Panel</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item
          ...
          to="/settings"
          style="border-radius: 15px"
          active-class="grey darken-4 ma-2 "
        >
        ...
        <v-list-item
          ...
          to="/help"
          style="border-radius: 15px"
          active-class="grey darken-4 ma-2 slider"
        >
          <v-list-item-icon class="ma-4">
